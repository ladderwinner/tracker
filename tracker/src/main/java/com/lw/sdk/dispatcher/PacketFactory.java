...
public class PacketFactory {
    private static final String TAG = LadderWinner.tag(PacketFactory.class);
    @VisibleForTesting
    ...
    // "http://domain.com/LadderWinner.php?idsite=1&url=http://a.org&action_name=Test bulk log Pageview&rec=1"
    @Nullable
