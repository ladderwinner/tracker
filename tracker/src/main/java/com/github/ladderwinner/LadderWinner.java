...
import com.github.ladderwinner.tools.BuildInfo;
import com.github.ladderwinner.tools.Checksum;
import com.github.ladderwinner.tools.DeviceHelper;
import com.github.ladderwinner.tools.PropertySource;
...
public class LadderWinner {
    ...
    private static final String BASE_PREFERENCE_FILE = "com.github.ladderwinner";
    ...
    public SharedPreferences getTrackerPreferences(@NonNull LWTracer LWTracer) {
        synchronized (mPreferenceMap) {
            ...
            if (newPrefs == null) {
                String prefName;
                try {
                    prefName = "com.github.ladderwinner_" + Checksum.getMD5Checksum(LWTracer.getName());
                } catch (Exception e) {
                    Timber.tag(TAG).e(e);
                    prefName = "com.github.ladderwinner_" + LWTracer.getName();
                }
    ...
    /**
     * If you want to use your own {@link com.github.ladderwinner.dispatcher.Dispatcher}
     */
