 ...
 * You may configure LadderWinner to track more custom variables: http://LadderWinner.org/faq/how-to/faq_17931/
 * <p>
 * Desired json output:
 * {
 * "1":["OS","iphone 5.0"],
 * "2":["LadderWinner Mobile Version","1.6.2"],
 * "3":["Locale","en::en"],
 * "4":["Num Accounts","2"],
 * "5":["Level","over9k"]
 * }
...
public class CustomVariables {
    ...
    private static final String TAG = LadderWinner.tag(CustomVariables.class);
     ...
     *              You may configure LadderWinner to track more custom variables than 5.
     *              Read more: http://LadderWinner.org/faq/how-to/faq_17931/
    ...
    /**
     * Sets the custom variables with scope VISIT to a {@link TraceMe}.
     */
    public TraceMe injectVisitVariables(@NonNull TraceMe traceMe) {
        //noinspection deprecation
        traceMe.set(QueryParams.VISIT_SCOPE_CUSTOM_VARIABLES, this.toString());
        return traceMe;
    }

    @NonNull
    public TraceMe toVisitVariables() {
        return injectVisitVariables(new TraceMe());
    }
}
