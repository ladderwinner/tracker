...
import com.github.ladderwinner.tools.ActivityHelper;
import com.github.ladderwinner.tools.CurrencyFormatter;
...
public class LWTraceUtil {
    private static final String TAG = LadderWinner.tag(LWTraceUtil.class);
    protected final TraceMe mBaseTraceMe;

    private LWTraceUtil() {
        this(null);
    }

    private LWTraceUtil(@Nullable TraceMe baseTraceMe) {
        if (baseTraceMe == null) baseTraceMe = new TraceMe();
        mBaseTraceMe = baseTraceMe;
    }

    public static LWTraceUtil trace() {
        return new LWTraceUtil();
    }

    public static LWTraceUtil trace(@Nullable TraceMe base) {
        return new LWTraceUtil(base);
    }

    static abstract class BaseEvent {

        private final LWTraceUtil mBaseBuilder;

        BaseEvent(LWTraceUtil baseBuilder) {
            mBaseBuilder = baseBuilder;
        }

        TraceMe getBaseTrackMe() {
            return mBaseBuilder.mBaseTraceMe;
        }

        /**
         * May throw an {@link IllegalArgumentException} if the TrackMe was build with incorrect arguments.
         */
        public abstract TraceMe build();

        public void with(LadderWinnerApplication LadderWinnerApplication) {
            with(LadderWinnerApplication.getTracker());
        }

        public void with(LWTracer LWTracer) {
            TraceMe traceMe = build();
            LWTracer.trace(traceMe);
        }

        public boolean safelyWith(LadderWinnerApplication LadderWinnerApplication) {
            return safelyWith(LadderWinnerApplication.getTracker());
        }

        /**
         * {@link #build()} can throw an exception on illegal arguments.
         * This can be used to avoid crashes when using dynamic {@link TraceMe} arguments.
         *
         * @return false if an error occured, true if the TrackMe has been submitted to be dispatched.
         */
        public boolean safelyWith(LWTracer LWTracer) {
            try {
                TraceMe traceMe = build();
                LWTracer.trace(traceMe);
    ...
    public static class Screen extends BaseEvent {
        ...
        Screen(LWTraceUtil baseBuilder, String path) {
            super(baseBuilder);
            mPath = path;
        }
         ...
         *
         * @see com.github.ladderwinner.extra.CustomDimension and {@link #dimension(int, String)}
         * @deprecated Consider using <a href="http://LadderWinner.org/docs/custom-dimensions/">Custom Dimensions</a>
         */
        @Deprecated
        ...
        public TraceMe build() {
            ...
            final TraceMe traceMe = new TraceMe(getBaseTrackMe())
            ...
            if (mCustomVariables.size() > 0) {
                ...
                traceMe.set(QueryParams.SCREEN_SCOPE_CUSTOM_VARIABLES, mCustomVariables.toString());
            }
            for (Map.Entry<Integer, String> entry : mCustomDimensions.entrySet()) {
                CustomDimension.setDimension(traceMe, entry.getKey(), entry.getValue());
            }
            return traceMe;
        }
    }
    ...
    public static class EventBuilder extends BaseEvent {
        ...
        EventBuilder(LWTraceUtil builder, String category, String action) {
            super(builder);
            mCategory = category;
            mAction = action;
        }
        ...
        @Override
        public TraceMe build() {
            TraceMe traceMe = new TraceMe(getBaseTrackMe())
                    .set(QueryParams.URL_PATH, mPath)
                    .set(QueryParams.EVENT_CATEGORY, mCategory)
                    .set(QueryParams.EVENT_ACTION, mAction)
                    .set(QueryParams.EVENT_NAME, mName);
            if (mValue != null) traceMe.set(QueryParams.EVENT_VALUE, mValue);
            return traceMe;
        }
    }

    /**
     * By default, Goals in LadderWinner are defined as "matching" parts of the screen path or screen title.
     ...
     *
     * @param idGoal id of goal as defined in LadderWinner goal settings
     */
    ...
    public static class Goal extends BaseEvent {
        ...
        Goal(LWTraceUtil baseBuilder, int idGoal) {
            super(baseBuilder);
            mIdGoal = idGoal;
        }
        ...
        public TraceMe build() {
            ...
            TraceMe traceMe = new TraceMe(getBaseTrackMe()).set(QueryParams.GOAL_ID, mIdGoal);
            if (mRevenue != null) traceMe.set(QueryParams.REVENUE, mRevenue);
            return traceMe;
        }
    }

    /**
     * Tracks an  <a href="http://LadderWinner.org/faq/new-to-LadderWinner/faq_71/">Outlink</a>
     *
    ...
    public static class Outlink extends BaseEvent {
        ...
        Outlink(LWTraceUtil baseBuilder, URL url) {
            super(baseBuilder);
            mURL = url;
        }
        ...
        public TraceMe build() {
            ...
            return new TraceMe(getBaseTrackMe())
    ...
    /**
     * Tracks an  <a href="http://LadderWinner.org/docs/site-search/">site search</a>
     *
    ...
    public static class Search extends BaseEvent {
        ...
        Search(LWTraceUtil baseBuilder, String keyword) {
            super(baseBuilder);
            mKeyword = keyword;
        }
        ...
        public TraceMe build() {
            ...
            if (mCount != null) traceMe.set(QueryParams.SEARCH_NUMBER_OF_HITS, mCount);
            return traceMe;
        }
    }
     ...
     * Case {@link com.github.ladderwinner.extra.DownloadTracker.Extra.ApkChecksum}:<br>
     * http://packageName:versionCode/apk-md5-checksum<br>
     * <p>
     * Case {@link com.github.ladderwinner.extra.DownloadTracker.Extra.None}:<br>
    ...
    public static class Download {
        ...
        Download(DownloadTracker downloadTracker, LWTraceUtil baseBuilder) {
         ...
         *
         * @param identifier {@link com.github.ladderwinner.extra.DownloadTracker.Extra.ApkChecksum} or {@link com.github.ladderwinner.extra.DownloadTracker.Extra.None}
         * @return this object, to chain calls.
         */
        ...
        public void with(LWTracer LWTracer) {
            if (mDownloadTracker == null) mDownloadTracker = new DownloadTracker(LWTracer);
            if (mVersion != null) mDownloadTracker.setVersion(mVersion);
            if (mForced) mDownloadTracker.trackNewAppDownload(mBaseBuilder.mBaseTraceMe, mExtra);
            else mDownloadTracker.trackOnce(mBaseBuilder.mBaseTraceMe, mExtra);
        }
    }
    ...
    public static class ContentImpression extends BaseEvent {
        ...
        ContentImpression(LWTraceUtil baseBuilder, String contentName) {
            super(baseBuilder);
    ...
    public static class ContentInteraction extends BaseEvent {
        ...
        ContentInteraction(LWTraceUtil baseBuilder, String contentName, String interaction) {
            super(baseBuilder);
            mContentName = contentName;
    ...
    public static class CartUpdate extends BaseEvent {
        ...
        CartUpdate(LWTraceUtil baseBuilder, int grandTotal) {
            super(baseBuilder);
    ...
    public static class Order extends BaseEvent {
        ...
        Order(LWTraceUtil baseBuilder, String orderId, int grandTotal) {
            super(baseBuilder);
            mOrderId = orderId;
            mGrandTotal = grandTotal;
        }
     ...
     * Keep in mind LadderWinner is not a crash tracker, use this sparingly.
     * <p>
     ...
     * This would mean the same exception (event) is tracked as different events by LadderWinner.
     *
    ...
    public static class Exception extends BaseEvent {
        ...
        Exception(LWTraceUtil baseBuilder, Throwable throwable) {
            super(baseBuilder);
     ...
     * <p>
     * See discussion here: https://github.com/LadderWinner-org/LadderWinner-sdk-android/issues/28
     */
    ...
    public static class UncaughtExceptions {
        ...
        UncaughtExceptions(LWTraceUtil baseBuilder) {
            mBaseBuilder = baseBuilder;
        }

        /**
         * @param LWTracer the tracker that should receive the exception events.
         * @return returns the new (but already active) exception handler.
         */
        public Thread.UncaughtExceptionHandler with(LWTracer LWTracer) {
            if (Thread.getDefaultUncaughtExceptionHandler() instanceof LadderWinnerExceptionHandler) {
                throw new RuntimeException("Trying to wrap an existing LadderWinnerExceptionHandler.");
            }
            Thread.UncaughtExceptionHandler handler = new LadderWinnerExceptionHandler(LWTracer, mBaseBuilder.mBaseTraceMe);
    ...
    public static class AppTracking {
        ...
        public AppTracking(LWTraceUtil baseBuilder, Application application) {
            mBaseBuilder = baseBuilder;
            mApplication = application;
        }

        /**
         * @param LWTracer the tracker to use
         * @return the registered callback, you need this if you wanted to unregister the callback again
         */
        @TargetApi(Build.VERSION_CODES.ICE_CREAM_SANDWICH)
        public Application.ActivityLifecycleCallbacks with(final LWTracer LWTracer) {
            final Application.ActivityLifecycleCallbacks callback = new Application.ActivityLifecycleCallbacks() {
                ...
                public void onActivityResumed(Activity activity) {
                    mBaseBuilder.screen(activity).with(LWTracer);
                }
    ...
    public Dimension dimension(int id, String value) {
        return new Dimension(mBaseTraceMe).dimension(id, value);
    }

    public static class Dimension extends LWTraceUtil {

        Dimension(TraceMe base) {
            super(base);
        }

        @Override
        public Dimension dimension(int id, String value) {
            CustomDimension.setDimension(mBaseTraceMe, id, value);
            return this;
        }
    }
    ...
    public static class VisitVariables extends LWTraceUtil {

        public VisitVariables(LWTraceUtil baseBuilder, CustomVariables customVariables) {
            super(baseBuilder.mBaseTraceMe);
            CustomVariables mergedVariables = new CustomVariables(mBaseTraceMe.get(QueryParams.VISIT_SCOPE_CUSTOM_VARIABLES));
            mergedVariables.putAll(customVariables);
            mBaseTraceMe.set(QueryParams.VISIT_SCOPE_CUSTOM_VARIABLES, mergedVariables.toString());
        }
         ...
         */
        public VisitVariables visitVariables(int id, String name, String value) {
            CustomVariables customVariables = new CustomVariables(mBaseTraceMe.get(QueryParams.VISIT_SCOPE_CUSTOM_VARIABLES));
            customVariables.put(id, name, value);
            mBaseTraceMe.set(QueryParams.VISIT_SCOPE_CUSTOM_VARIABLES, customVariables.toString());
            return this;
        }
    }
}
