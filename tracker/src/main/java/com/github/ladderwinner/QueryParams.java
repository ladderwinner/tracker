 ...
 * See <a href="http://developer.LadderWinner.org/api-reference/tracking-api">Tracking HTTP API</a>
 */
public enum QueryParams {
     ...
     * It is possible to <a href="http://LadderWinner.org/faq/how-to/#faq_62">use slashes / to set one or several categories for this action.</a>
    ...
    REFERRER("urlref"),
    /**
     * Visit scope <a href="http://LadderWinner.org/docs/custom-variables/">custom variables</a>.<p>
     ...
     * @see com.github.ladderwinner.extra.CustomDimension
     */
    @Deprecated
    ...
    /**
     * The Campaign name (see <a href="http://LadderWinner.org/docs/tracking-campaigns/">Tracking Campaigns</a>).<p>
     * Used to populate the Referrers &gt; Campaigns report.
     * Note: this parameter will only be used for the first pageview of a visit.
     */
    CAMPAIGN_NAME("_rcn"),
    /**
     * The Campaign Keyword (see <a href="http://LadderWinner.org/docs/tracking-campaigns/">Tracking Campaigns</a>).<p>
     ...
     * This value is used to detect the visitor's country if <a href="http://LadderWinner.org/faq/troubleshooting/#faq_65">GeoIP</a> is not enabled.
     */
    LANGUAGE("lang"),
    /**
     ...
     * To access this value, users must be logged-in in your system so you can fetch this user ID from your system, and pass it to LadderWinner.
    ...
    /**
     * Page scope <a href="http://LadderWinner.org/docs/custom-variables/">custom variables</a>.
     * This is a JSON encoded string of the custom variable array.
     * @deprecated Consider using <a href="http://LadderWinner.org/docs/custom-dimensions/">Custom Dimensions</a>
     * @see com.github.ladderwinner.extra.CustomDimension
     */
     ...
     * When specified, the request will not be tracked as a normal pageview but will instead be tracked as a <a href="http://LadderWinner.org/docs/site-search/">Site Search</a> request.
     */
     ...
     * Note: if you record data in the past, you will need to <a href="http://LadderWinner.org/faq/how-to/#faq_59">force LadderWinner to re-process reports for the past dates.</a>
     */
     ...
     *
     * @see <a href="http://LadderWinner.org/docs/content-tracking/">Content Tracking</a>
     */
    CONTENT_NAME("c_n"),
    /**
     ...
     *
     * @see <a href="http://LadderWinner.org/docs/event-tracking/">Event Tracking</a>
     */
    EVENT_CATEGORY("e_c"),
    /**
    ...
    // Other parameters
    /**
     * If set to 0 (send_image=0) LadderWinner will respond with a HTTP 204 response code instead of a GIF image.<p>
     * This improves performance and can fix errors if images are not allowed to be obtained directly (eg Chrome Apps). Available since LadderWinner 2.10.0
     */
