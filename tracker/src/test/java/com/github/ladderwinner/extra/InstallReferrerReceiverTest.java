...
public class InstallReferrerReceiverTest extends DefaultTestCase {
    ...
    // adb shell am broadcast -a com.android.vending.INSTALL_REFERRER -n com.lw.demo/com.github.ladderwinner.extra.InstallReferrerReceiver --es "referrer" "utm_medium%3Dpartner%26utm_campaign%3Dpart
    @Test
    public void testReceiveGooglePlay() throws Exception {
        ...
        Thread.sleep(250);
        String referrerDataFromPreferences = getLadderWinner().getPreferences().getString(InstallReferrerReceiver.PREF_KEY_INSTALL_REFERRER_EXTRAS, null);
        ...
        receiver.onReceive(Robolectric.application.getApplicationContext(), testIntent);
        Thread.sleep(250);
        referrerDataFromPreferences = getLadderWinner().getPreferences().getString(InstallReferrerReceiver.PREF_KEY_INSTALL_REFERRER_EXTRAS, null);
        assertEquals(testReferrerData1, referrerDataFromPreferences);
