...
public class LegacySettingsPorterTest extends BaseTest {
    ...
    public void setup() {
        ...
        when(mLadderWinner.getPreferences()).thenReturn(mPrefs);
        when(mLWTracer.getPreferences()).thenReturn(mTrackerPrefs);
        mPorter = new LegacySettingsPorter(mLadderWinner);
    }

    @Test
    public void testPort_optOut_empty() {
        when(mPrefs.getBoolean(LegacySettingsPorter.LEGACY_PREF_OPT_OUT, false)).thenReturn(false);
        mPorter.port(mLWTracer);
    ...
    public void testPort_optOut_exists() {
        ...
        verify(mTrackerPrefsEditor).putBoolean(LWTracer.PREF_KEY_TRACKER_OPTOUT, true);
    ...
    public void testPort_userId_exists() {
        ...
        verify(mTrackerPrefs).edit();
        verify(mTrackerPrefsEditor).putString(LWTracer.PREF_KEY_TRACKER_USERID, "test");
    ...
    public void testPort_firstVisit_exists() {
        ...
        verify(mTrackerPrefs).edit();
        verify(mTrackerPrefsEditor).putLong(LWTracer.PREF_KEY_TRACKER_FIRSTVISIT, 1338);
    ...
    public void testPort_visitCount_exists() {
        ...
        verify(mTrackerPrefs).edit();
        verify(mTrackerPrefsEditor).putLong(LWTracer.PREF_KEY_TRACKER_VISITCOUNT, 16L);
    ...
    public void testPort_previousVisit_exists() {
        ...
        verify(mTrackerPrefs).edit();
        verify(mTrackerPrefsEditor).putLong(LWTracer.PREF_KEY_TRACKER_PREVIOUSVISIT, 1111L);
