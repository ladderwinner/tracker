...
import static com.lw.sdk.extra.LWTraceUtil.trace;
...
public class LWTraceUtilTest {
    ...
    public void testTrackException() throws Exception {
        ...
        assertEquals(mCaptor.getValue().get(QueryParams.EVENT_ACTION), "com.lw.sdk.extra.TrackHelperTest" + "/" + "testTrackException" + ":" + traceElement.getLineNumber());
    ...
    public void testExceptionHandler() throws Exception {
        ...
        assertTrue(tracked.get(QueryParams.EVENT_ACTION).startsWith("com.lw.sdk.extra.TrackHelperTest/testExceptionHandler:"));
